				...
				<?php $section_five_image = get_field( 'section_five_image' ); ?>
					...
					<?php if ( $section_five_image ) { ?>
						...
						<div class='sec-five-image-wrapper'>
							...
							<span class='sec-five-image-title'><?php the_field( 'section_five_image_description' ); ?></span><!-- sec-five-image-title -->
							...
							<a class='button sec-five-img-button' href='<?php the_field( 'section_five_button_link' ); ?>'><?php the_field( 'section_five_button_verbiage' ); ?></a><!-- button sec-five-img-button -->
