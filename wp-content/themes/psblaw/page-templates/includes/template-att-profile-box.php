...
<div class='att-email-wrapper'>
  ...
  <span>Email</span><a class='att-email' href="mailto:<?php the_field( 'attorney_email' ); ?>"><?php the_field( 'attorney_email' ); ?></a>
  ...
  <?php if ( get_field( 'download_vcard' ) ) { ?>
    <a class='button vcard' href='<?php the_field( 'download_vcard' ); ?>'><?php the_field( 'download_vcard_verbiage' ); ?></a><!-- button vcard -->
<?php } ?>
