<div class='page-title-wrapper'>
  ...
  <h1 class="page-title page-large-content-title"> <?php if(is_post_type_archive('case_results')) {echo "Case Results";};?><?php if(is_tax('case_results_category')) {echo single_term_title();};?></h1>
