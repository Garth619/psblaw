        ...
        var amm_event = function() {
            ...
            amm_plugin.$menu.on('mouseup', 'li.menu-item', function(e) {
                ...
                setTimeout(function() {
                    ...
                    var depth_drag_item = amm_menu_item_depth($dropped_item);
                ...
                var menu_object_change_status = 'yes';
            });
            ...
            jQuery(document).on('click', '.item-controls span.menu_sub_details', function(e) {
                ...
                var item = jQuery(this).parents('li.menu-item');
